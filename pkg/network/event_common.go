...
type ConnectionStats struct {
	...
	// * A value of 0 means that this either a UDP connection or the
	//   connection was established before system-probe was initialized;
	// * Value 1 represents a connection that was established after system-probe started;
	// * Values greater than 1 should be rare, but can occurr when multiple connections
